      ...
      {({ values }) => (
        <div className="mt-5 p-5 bg-white rounded-md shadow-md">
          <label for="large-input" className="flex justify-between item-center">
            <h1 className="text-gray-700 font-bold mb-2 text-lg">Skill</h1>
          ...
          <div className={!displaySkill ? "hidden" : "block"}>
            {Skill.map((input, index) => (
              ...
              >
                ...
                >
                  {input.skillname ? input.skillname : "(Not Specified)"}
                  ...
                  <div key={index} className="mb-3 ">
                    <div className="grid gap-6 mb-6 laptop:grid-cols-2">
                      <div>
                        ...
                        ></Field>
                        <ErrorMessage name="skillname" className='text-red-500 text-xs italic'/>
                      </div>
                      <div>
                        <label
                          for="level"
                        ...
                        <Field
                          ...
                          required
                        />
                        <ErrorMessage name="level" className='text-red-500 text-xs italic'/>
                      </div>
                    </div>
